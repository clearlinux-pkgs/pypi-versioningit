...
Source0  : https://files.pythonhosted.org/packages/af/5b/8f4acd9a691755a20ee21fadab0045243e9aef3f5efcc0977c338c140eb5/versioningit-3.1.3.tar.gz
...
%prep
%setup -q -n versioningit-3.1.3
cd %{_builddir}/versioningit-3.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747076498
